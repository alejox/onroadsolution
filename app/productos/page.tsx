            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="group relative overflow-hidden rounded-lg border bg-background p-2 transition-all hover:shadow-md">
                ...
                <div className="p-4">
                  ...
                  <p className="line-clamp-2 text-sm text-gray-500">
                    Con nuestra pantalla con conectividad CP/AA para moto,
                    puedes navegar y olvidarte de estar sacando tu teléfono
                    mientras manejas.
                  </p>
              ...
              <div className="group relative overflow-hidden rounded-lg border bg-background p-2 transition-all hover:shadow-md">
                ...
                <div className="p-4">
                  ...
                  <p className="line-clamp-2 text-sm text-gray-500">
                    Transforma la experiencia de traslado de tus pasajeros en la
                    mejor parte de su día.
                  </p>
              ...
              <div className="group relative overflow-hidden rounded-lg border bg-background p-2 transition-all hover:shadow-md">
                ...
                <div className="p-4">
                  ...
                  <p className="line-clamp-2 text-sm text-gray-500">
                    Qué gran experiencia es tener un baul trasero que se abre y
                    cierra por sí solo, en el momento que lo desees.
                  </p>
              ...
              <div className="group relative overflow-hidden rounded-lg border bg-background p-2 transition-all hover:shadow-md">
                ...
                <div className="p-4">
                  ...
                  <p className="line-clamp-2 text-sm text-gray-500">
                    Seguridad y tecnología. Graba tus recorridos y utiliza lo
                    mejor del mercado para mantener conectividad.
                  </p>
              ...
              <div className="group relative overflow-hidden rounded-lg border bg-background p-2 transition-all hover:shadow-md">
                ...
                <div className="p-4">
                  ...
                  <p className="line-clamp-2 text-sm text-gray-500">
                    Con nuestros iniciadores portátiles, podemos iniciar desde
                    vehículos de pasajeros hasta vehículos comerciales.
                  </p>
